 ...
 */
export const createWorkspace = async (workspaceData: Record<string, any>) => {
 ...
 */
export const getWorkspaceById = async (workspaceId: any, organizationId: any) => {
 ...
 * @param {string} organizationId
 */
export const deleteWorkspace = async (workspaceId: any, organizationId: any, userId: any) => {
  const workspace = await Workspace.findOneAndUpdate(
