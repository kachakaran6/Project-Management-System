...
import publicPageRoutes from "./modules/page/page.public.routes.js";
import pageV2Routes from "./modules/page/page.routes.v2.js";
...
app.use("/api/v2/pages", pageV2Routes);
