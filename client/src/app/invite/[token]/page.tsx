...
export default function PublicInvitePage() {
  ...
  return (
    <main className="min-h-screen bg-[radial-gradient(circle_at_top,_rgba(52,211,153,0.12),_transparent_35%),linear-gradient(180deg,_#050816_0%,_#0b1020_100%)] px-4 py-10 text-slate-100">
