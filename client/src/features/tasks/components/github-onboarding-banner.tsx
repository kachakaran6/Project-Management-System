...
export function GithubOnboardingBanner() {
  ...
  return (
    <div className="mx-4 md:mx-6 mt-4 animate-in slide-in-from-top-4 duration-500">
      <div className="relative overflow-hidden rounded-3xl border border-primary/20 bg-primary/5 px-6 py-5 shadow-2xl shadow-primary/5">
        {/* Background Sparkles */}
        ...
        <div className="flex flex-col md:flex-row items-center gap-6 relative z-10">
          <div className="shrink-0 size-14 rounded-2xl bg-background border border-border/40 shadow-xl flex items-center justify-center text-primary transform -rotate-3">
          ...
          <div className="flex items-center gap-3">
             <Button 
              className="rounded-2xl font-black uppercase tracking-widest text-[11px] h-10 px-6 shadow-lg shadow-primary/20"
