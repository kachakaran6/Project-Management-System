  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        weekday: "text-muted-foreground rounded-button font-normal text-[0.8rem] text-center",
        week: "grid grid-cols-7 w-full mt-2",
        day: cn(
          buttonVariants({ variant: "ghost" }),
          "h-9 w-9 p-0 font-normal aria-selected:opacity-100 flex items-center justify-center mx-auto hover:bg-accent hover:text-accent-foreground"
        ),
